...
INVENTORY="~/kubernetes/kubespray/inventory/sandbox/hosts.yml"
...
echo "=========================================="
for host in sandbox-master01 sandbox-master02 sandbox-master03 sandbox-node01 sandbox-node02 ; do
    echo "Cleaning $host..."
